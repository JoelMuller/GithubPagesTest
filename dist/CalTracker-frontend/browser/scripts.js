...
!function(t, e) {
  ...
  function a(t2, e2) {
    for (var i2 = 0; i2 < e2.length; i2++) {
      var a2 = e2[i2];
      a2.enumerable = a2.enumerable || false, a2.configurable = true, "value" in a2 && (a2.writable = true), Object.defineProperty(t2, p(a2.key), a2);
    }
  }
  function s(t2, e2, i2) {
  ...
  function o(t2, e2, i2) {
    return (e2 = p(e2)) in t2 ? Object.defineProperty(t2, e2, { value: i2, enumerable: true, configurable: true, writable: true }) : t2[e2] = i2, t2;
  }
  function n(t2) {
  ...
  var v = function() {
    ...
    return s(t2, [{ key: "roundPathCorners", value: function(t3, e2) {
      ...
      var e2, i2 = t3.j, a2 = t3.realIndex, s2 = t3.pathFrom, r2 = t3.pathTo, o2 = t3.stroke, n2 = t3.strokeWidth, l2 = t3.strokeLinecap, h2 = t3.fill, c2 = t3.animationDelay, g2 = t3.initialSpeed, u2 = t3.dataChangeSpeed, f2 = t3.className, p2 = t3.shouldClipToGrid, x2 = void 0 === p2 || p2, b2 = t3.bindEventsOnPaths, v2 = void 0 === b2 || b2, w2 = t3.drawShadow, k2 = void 0 === w2 || w2, A2 = this.w, S2 = new y(this.ctx), C2 = new m(this.ctx), L2 = this.w.config.chart.animations.enabled, P2 = L2 && this.w.config.chart.animations.dynamicAnimation.enabled, M2 = !!(L2 && !A2.globals.resized || P2 && A2.globals.dataChanged && A2.globals.shouldAnimate);
      ...
      var z2 = this.drawPath({ d: e2, stroke: o2, strokeWidth: n2, fill: h2, fillOpacity: 1, classes: f2, strokeLinecap: l2, strokeDashArray: T2 });
      ...
      var e2 = this, i2 = t3.x, a2 = t3.y, s2 = t3.text, r2 = t3.textAnchor, o2 = t3.fontSize, n2 = t3.fontFamily, l2 = t3.fontWeight, h2 = t3.foreColor, c2 = t3.opacity, g2 = t3.maxWidth, u2 = t3.cssClass, f2 = void 0 === u2 ? "" : u2, p2 = t3.isPlainText, x2 = void 0 === p2 || p2, b2 = t3.dominantBaseline, v2 = void 0 === b2 ? "auto" : b2, m2 = this.w;
      void 0 === s2 && (s2 = "");
      var y2 = s2;
    ...
    return s(t2, [{ key: "isValidDate", value: function(t3) {
      ...
      var i2 = this.w.globals.locale, a2 = this.w.config.xaxis.labels.datetimeUTC, s2 = ["\0"].concat(f(i2.months)), r2 = [""].concat(f(i2.shortMonths)), o2 = [""].concat(f(i2.days)), n2 = [""].concat(f(i2.shortDays));
      function l2(t4, e3) {
        var i3 = t4 + "";
    ...
    return s(t2, [{ key: "getLabel", value: function(t3, e2, i2, a2) {
      var s2 = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : [], r2 = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : "12px", o2 = !(arguments.length > 6 && void 0 !== arguments[6]) || arguments[6], n2 = this.w, l2 = void 0 === t3[a2] ? "" : t3[a2], h2 = l2, c2 = n2.globals.xLabelFormatter, d2 = n2.config.xaxis.labels.formatter, g2 = false, u2 = new L(this.ctx), f2 = l2;
      o2 && (h2 = u2.xLabelFormat(c2, l2, f2, { i: a2, dateFormatter: new C(this.ctx).formatDate, w: n2 }), void 0 !== d2 && (h2 = d2(l2, t3[a2], { i: a2, dateFormatter: new C(this.ctx).formatDate, w: n2 })));
      var p2, x2;
  ...
  var T = { name: "en", options: { months: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], shortMonths: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], days: ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"], shortDays: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"], toolbar: { exportToSVG: "Download SVG", exportToPNG: "Download PNG", exportToCSV: "Download CSV", menu: "Menu", selection: "Selection", selectionZoom: "Selection Zoom", zoomIn: "Zoom In", zoomOut: "Zoom Out", pan: "Panning", reset: "Reset Zoom" } } }, z = function() {
    ...
    return s(t2, [{ key: "drawAxesAnnotations", value: function() {
      ...
      return f2 && l2.insertBefore(f2.node, u2), i2 && n2.globals.memory.methodsToExec.push({ context: o2, id: g2.id ? g2.id : v.randomId(), method: r2, label: "addAnnotation", params: e2 }), a2;
    ...
    ("function" == typeof f2 && (g2 = f2(g2, p2)), null !== (e2 = l2.config.series[s2].data[r2]) && void 0 !== e2 && e2.x && (d2 = l2.config.series[s2].data[r2].x), i2) || "datetime" === l2.config.xaxis.type && (d2 = new L(a2).xLabelFormat(l2.globals.ttKeyFormatter, d2, d2, { i: void 0, dateFormatter: new C(a2).formatDate, w: l2 }));
    ...
    return s(t2, [{ key: "clippedImgArea", value: function(t3) {
      ...
      if (void 0 === r2.gradient.gradientToColors || 0 === r2.gradient.gradientToColors.length) o2 = "dark" === r2.gradient.shade ? h2.shadeColor(-1 * parseFloat(r2.gradient.shadeIntensity), e2.indexOf("rgb") > -1 ? v.rgb2hex(e2) : e2) : h2.shadeColor(parseFloat(r2.gradient.shadeIntensity), e2.indexOf("rgb") > -1 ? v.rgb2hex(e2) : e2);
        ...
        o2 = p2, p2.indexOf("rgba") > -1 && (f2 = v.getOpacityFromRGBA(p2));
      } else o2 = e2;
      ...
      return g2.indexOf("rgb") > -1 && (g2 = v.rgb2hex(g2)), o2.indexOf("rgb") > -1 && (o2 = v.rgb2hex(o2)), l2.drawGradient(c2, g2, o2, u2, f2, n2.size, r2.gradient.stops, r2.gradient.colorStops, s2);
    } }]), t2;
  }(), N = function() {
    function t2(e2, a2) {
      i(this, t2), this.ctx = e2, this.w = e2.w;
    ...
    return s(t2, [{ key: "dataLabelsCorrection", value: function(t3, e2, i2, a2, s2, r2, o2) {
      ...
      var e2 = this, i2 = t3.type, a2 = t3.pos, s2 = t3.i, r2 = t3.j, o2 = t3.isRangeStart, n2 = t3.strokeWidth, l2 = void 0 === n2 ? 2 : n2, h2 = this.w, c2 = new w(this.ctx), d2 = h2.config.dataLabels, g2 = 0, u2 = 0, f2 = r2, p2 = null;
      ...
      for (var x2 = 0; x2 < a2.x.length; x2++) if (g2 = a2.x[x2] + d2.offsetX, u2 = a2.y[x2] + d2.offsetY + l2, !isNaN(g2)) {
        ...
        if ("bubble" === h2.config.chart.type) v2 = m2(b2 = h2.globals.seriesZ[s2][f2]), u2 = a2.y[x2], u2 = new W(this.ctx).centerTextInBubble(u2, s2, f2).y;
      ...
      var e2 = this.w, i2 = new w(this.ctx), a2 = t3.x, s2 = t3.y, r2 = t3.i, o2 = t3.j, n2 = t3.text, l2 = t3.textAnchor, h2 = t3.fontSize, c2 = t3.parent, d2 = t3.dataLabelsConfig, g2 = t3.color, u2 = t3.alwaysDrawDataLabel, f2 = t3.offsetCorrection, p2 = t3.className, x2 = null;
      ...
      if ("bar" !== e2.config.chart.type && "rangeBar" !== e2.config.chart.type || (m2 = 0, k2 = 0), e2.globals.isSlopeChart && (0 !== o2 && (m2 = -2 * d2.offsetX + 5), 0 !== o2 && o2 !== e2.config.series[r2].data.length - 1 && (m2 = 0)), b2.drawnextLabel) {
        if ((x2 = i2.drawText({ width: 100, height: parseInt(d2.style.fontSize, 10), x: a2 + m2, y: s2 + k2, foreColor: v2, textAnchor: l2 || d2.textAnchor, text: n2, fontSize: h2 || d2.style.fontSize, fontFamily: d2.style.fontFamily, fontWeight: d2.style.fontWeight || "normal" })).attr({ class: p2 || "apexcharts-datalabel", cx: a2, cy: s2 }), d2.dropShadow.enabled) {
    ...
    return s(t2, [{ key: "isMultiFormat", value: function() {
      ...
      var n2 = [], l2 = f(new Set(a2.series.map(function(t4) {
        return t4.group;
      })));
    ...
    return s(t2, [{ key: "scaleSvgNode", value: function(t3, e2) {
      ...
      var h2, c2, d2 = [], g2 = [], u2 = "", p2 = l2.globals.series.map(function(t4, e3) {
      ...
      }, m2 = Math.max.apply(Math, f(i2.map(function(t4) {
        ...
        if (d2.length && 0 === e3 && g2.push(d2.join(r2)), t4.data) {
          t4.data = t4.data.length && t4.data || f(Array(m2)).map(function() {
            return "";
          });
            ...
            if ("nullvalue" !== s3) {
              if (s3 || (y2.isFormatXY() ? s3 = i2[e3].data[a3].x : y2.isFormat2DArray() && (s3 = i2[e3].data[a3] ? i2[e3].data[a3][0] : "")), 0 === e3) {
                ...
                for (var o3 = 0; o3 < l2.globals.series.length; o3++) {
                  var n3, h3 = y2.isFormatXY() ? null === (n3 = i2[o3].data[a3]) || void 0 === n3 ? void 0 : n3.y : p2[o3][a3];
                  d2.push(b2(h3));
                }
              }
      ...
      d2.push(l2.config.chart.toolbar.export.csv.headerCategory), "boxPlot" === l2.config.chart.type ? (d2.push("minimum"), d2.push("q1"), d2.push("median"), d2.push("q3"), d2.push("maximum")) : "candlestick" === l2.config.chart.type ? (d2.push("open"), d2.push("high"), d2.push("low"), d2.push("close")) : "rangeBar" === l2.config.chart.type ? (d2.push("minimum"), d2.push("maximum")) : i2.map(function(t4, e3) {
        ...
        l2.globals.axisCharts ? A2(t4, e3) : ((d2 = []).push(x2(l2.globals.labels[e3])), d2.push(b2(p2[e3])), g2.push(d2.join(r2)));
    ...
    return s(t2, [{ key: "drawGridArea", value: function() {
      ...
      if (void 0 !== i2.config.grid.column.colors && i2.config.grid.column.colors.length > 0) {
        ...
        for (var h2 = i2.globals.padHorizontal, c2 = i2.globals.padHorizontal + i2.globals.gridWidth / l2, d2 = i2.globals.gridHeight, g2 = 0, u2 = 0; g2 < t3; g2++, u2++) {
          var f2;
          if (u2 >= i2.config.grid.column.colors.length && (u2 = 0), "datetime" === i2.config.xaxis.type) h2 = this.xaxisLabels[g2].position, c2 = ((null === (f2 = this.xaxisLabels[g2 + 1]) || void 0 === f2 ? void 0 : f2.position) || i2.globals.gridWidth) - this.xaxisLabels[g2].position;
    ...
    return s(t2, [{ key: "niceScale", value: function(t3, e2) {
      ...
      var b2 = (x2 = Math.abs(e2 - t3)) / p2, m2 = b2, y2 = Math.floor(Math.log10(m2)), w2 = Math.pow(10, y2), k2 = Math.ceil(m2 / w2);
      ...
      if (s2 && r2) {
        ...
        x2 = Math.abs(e2 - t3), b2 = v.getGCD(x2, b2), p2 = Math.round(x2 / b2);
      }
      if (d2 || s2 || r2 || (p2 = Math.ceil((x2 - n2) / (b2 + n2))) > 16 && v.getPrimeFactors(p2).length < 2 && p2++, !d2 && i2.forceNiceScale && 0 === h2.yValueDecimal && p2 > x2 && (p2 = x2, b2 = Math.round(x2 / p2)), p2 > a2 && (!d2 && !c2 || i2.forceNiceScale)) {
        var z2 = v.getPrimeFactors(p2), X2 = z2.length - 1, E2 = p2;
      ...
      do {
        N2 += b2, f2.push(v.stripNumber(N2, 7));
      } while (e2 - N2 > W2);
      ...
      i2.allSeriesCollapsed = true, i2.barGroups = [], a2.forEach(function(a3, o2) {
        ...
        a3.forEach(function(t4) {
          ...
          if (e2.chart.stacked) !function() {
            var t4 = i2.seriesX[a3[0]], s3 = [], r3 = [], f3 = [];
            n2.forEach(function() {
    ...
    return s(t2, [{ key: "init", value: function() {
      ...
      for (var f2 = t3; f2 < a2; f2++) {
        ...
        for (var m2 = x2; m2 <= b2 && m2 < r2.series[f2].length; m2++) {
          var y2 = l2[f2][m2];
          if (null !== y2 && v.isNumber(y2)) {
            switch (void 0 !== c2[f2][m2] && (o2 = Math.max(o2, c2[f2][m2]), e2 = Math.min(e2, c2[f2][m2])), void 0 !== h2[f2][m2] && (e2 = Math.min(e2, h2[f2][m2]), i2 = Math.max(i2, h2[f2][m2])), p2) {
              case "candlestick":
                void 0 !== r2.seriesCandleC[f2][m2] && (o2 = Math.max(o2, r2.seriesCandleH[f2][m2]), e2 = Math.min(e2, r2.seriesCandleL[f2][m2]));
                break;
              case "boxPlot":
                void 0 !== r2.seriesCandleC[f2][m2] && (o2 = Math.max(o2, r2.seriesCandleC[f2][m2]), e2 = Math.min(e2, r2.seriesCandleO[f2][m2]));
            }
            p2 && "candlestick" !== p2 && "boxPlot" !== p2 && "rangeArea" !== p2 && "rangeBar" !== p2 && (o2 = Math.max(o2, r2.series[f2][m2]), e2 = Math.min(e2, r2.series[f2][m2])), i2 = o2, r2.seriesGoals[f2] && r2.seriesGoals[f2][m2] && Array.isArray(r2.seriesGoals[f2][m2]) && r2.seriesGoals[f2][m2].forEach(function(t4) {
              n2 !== Number.MIN_VALUE && (n2 = Math.min(n2, t4.value), e2 = n2), o2 = Math.max(o2, t4.value), i2 = o2;
            }), v.isFloat(y2) && (y2 = v.noExponents(y2), r2.yValueDecimal = Math.max(r2.yValueDecimal, y2.toString().split(".")[1].length)), n2 > h2[f2][m2] && h2[f2][m2] < 0 && (n2 = h2[f2][m2]);
    ...
    return s(t2, [{ key: "drawYaxis", value: function(t3) {
      ...
      if (i2.config.yaxis[t3].labels.show) {
        var p2 = i2.globals.translateY + i2.config.yaxis[t3].labels.offsetY;
        i2.globals.isBarHorizontal ? p2 = 0 : "heatmap" === i2.config.chart.type && (p2 -= d2 / 2), p2 += parseInt(i2.config.yaxis[t3].labels.style.fontSize, 10) / 3;
        for (var x2 = function(l3) {
          ...
          }), k3 = a2.drawText({ x: b3, y: p2, text: w2.indexOf(x3) >= 0 ? "" : x3, textAnchor: m3, fontSize: r2, fontFamily: o2, fontWeight: n2, maxWidth: i2.config.yaxis[t3].labels.maxWidth, foreColor: Array.isArray(y3) ? y3[l3] : y3, isPlainText: false, cssClass: "apexcharts-yaxis-label " + s2.cssClass });
          l3 === c2 && (f2 = k3), h2.add(k3);
          ...
          if (A3.textContent = Array.isArray(x3) ? x3.join(" ") : x3, k3.node.appendChild(A3), 0 !== i2.config.yaxis[t3].labels.rotate) {
            var S3 = a2.rotateAroundCenter(f2.node), C3 = a2.rotateAroundCenter(k3.node);
    ...
    return s(t2, [{ key: "drawXCrosshairs", value: function() {
      ...
      if (t3.config.xaxis.crosshairs.show) {
        ...
        (!v.isNumber(A2) || A2 < 0) && (A2 = 0), m2.attr({ class: "apexcharts-xcrosshairs", x: 0, y: 0, y2: k2, width: A2, height: k2, fill: b2, filter: "none", "fill-opacity": t3.config.xaxis.crosshairs.opacity, stroke: t3.config.xaxis.crosshairs.stroke.color, "stroke-width": t3.config.xaxis.crosshairs.stroke.width, "stroke-dasharray": t3.config.xaxis.crosshairs.stroke.dashArray }), d2 && (m2 = i2.dropShadow(m2, { left: g2, top: u2, blur: f2, color: p2, opacity: x2 })), t3.globals.dom.elGraphical.add(m2);
      }
      ...
      return e2.config.yaxis.map(function(r2, o2) {
        ...
        if (!s2.isYAxisHidden(o2) && r2.labels.show && void 0 !== r2.labels.minWidth && (h2 = r2.labels.minWidth), !s2.isYAxisHidden(o2) && r2.labels.show && l2.result.length) {
          ...
          if (void 0 !== g2 && 0 !== g2.length || (g2 = l2.niceMax), e2.globals.isBarHorizontal) {
            ...
            g2 = v.getLargestStringFromArr(f2), g2 = c2(g2, { seriesIndex: o2, dataPointIndex: -1, w: e2 }), u2 = t3.dCtx.dimHelpers.getLargestStringFromMultiArr(g2, f2);
          }
          var p2 = new w(t3.dCtx.ctx), x2 = "rotate(".concat(r2.labels.rotate, " 0 0)"), b2 = p2.getTextRects(g2, r2.labels.style.fontSize, r2.labels.style.fontFamily, x2, false), m2 = b2;
          g2 !== u2 && (m2 = p2.getTextRects(u2, r2.labels.style.fontSize, r2.labels.style.fontFamily, x2, false)), i2.push({ width: (h2 > m2.width || h2 > b2.width ? h2 : m2.width > b2.width ? m2.width : b2.width) + a2, height: m2.height > b2.height ? m2.height : b2.height });
    ...
    return s(t2, [{ key: "init", value: function() {
      ...
      if (g2.height = 2 * (n2 + c2) + "px", g2.width = 2 * (n2 + c2) + "px", g2.left = l2 + "px", g2.top = h2 + "px", a2.config.legend.markers.customHTML) g2.background = "transparent", g2.color = i2[e2], Array.isArray(a2.config.legend.markers.customHTML) ? a2.config.legend.markers.customHTML[e2] && (s2.innerHTML = a2.config.legend.markers.customHTML[e2]()) : s2.innerHTML = a2.config.legend.markers.customHTML();
        ...
        var u2 = new N(this.ctx).getMarkerConfig({ cssClass: "apexcharts-legend-marker apexcharts-marker apexcharts-marker-".concat(o2), seriesIndex: e2, strokeWidth: c2, size: n2 }), f2 = SVG(s2).size("100%", "100%"), p2 = new w(this.ctx).drawMarker(0, 0, d(d({}, u2), {}, { pointFillColor: Array.isArray(i2) ? i2[e2] : u2.pointFillColor, shape: o2 }));
      ...
      for (var o2 = e2.globals.legendFormatter, n2 = e2.config.legend.inverseOrder, l2 = n2 ? a2.length - 1 : 0; n2 ? l2 >= 0 : l2 <= a2.length - 1; n2 ? l2-- : l2++) {
        ...
        w.setAttrs(p2, { rel: l2 + 1, "data:collapsed": d2 || g2 }), (d2 || g2) && p2.classList.add("apexcharts-inactive-legend");
    ...
    return s(a2, [{ key: "init", value: function(t3) {
      ...
      if (a3.config.yaxis.forEach(function(t4, e4) {
        ...
        if (a3.globals.zoomEnabled) {
          var u2 = v.clone(a3.globals.initialConfig.yaxis), f2 = v.clone(a3.globals.initialConfig.xaxis);
    ...
    return s(t2, [{ key: "getNearestValues", value: function(t3) {
      ...
      if (r2.globals.isXNumeric) {
        ...
        x2 = (b2 = this.closestInMultiArray(k2, A2, m2, y2)).index, f2 = b2.j, null !== x2 && (m2 = r2.globals.seriesXvalues[x2], f2 = (b2 = this.closestInArray(k2, m2)).index);
      }
    ...
    return s(t2, [{ key: "drawSeriesTexts", value: function(t3) {
      ...
      for (var v2 = function(t4, r3) {
        ...
        null === s2 && (e2 = v3.yLbFormatter(h2.globals.series[a2], d(d({}, h2), {}, { seriesIndex: a2, dataPointIndex: a2 }))), i2.DOMHandling({ i: a2, t: m3, j: s2, ttItems: o2, values: { val: e2, goalVals: c2, xVal: u2, xAxisTTVal: p2, zVal: f2 }, seriesName: x2, shared: n2, pColor: b2 });
    ...
    function t2(e2) {
      i(this, t2), this.w = e2.w, this.ttCtx = e2, this.ctx = e2.ctx, this.tooltipPosition = new pt(e2);
    }
    ...
    return s(t2, [{ key: "getElTooltip", value: function(t3) {
      ...
      var r2, o2, n2, l2, h2, c2, g2, u2, f2, p2, x2, b2, v2, m2, y2, k2, A2 = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : null, S2 = this.w, C2 = e2;
      ...
      var F2 = d(d({ ttItems: s2, i: i2, j: a2 }, void 0 !== (null === (r2 = S2.globals.seriesRange) || void 0 === r2 || null === (o2 = r2[i2]) || void 0 === o2 || null === (n2 = o2[a2]) || void 0 === n2 || null === (l2 = n2.y[0]) || void 0 === l2 ? void 0 : l2.y1) && { y1: null === (h2 = S2.globals.seriesRange) || void 0 === h2 || null === (c2 = h2[i2]) || void 0 === c2 || null === (g2 = c2[a2]) || void 0 === g2 || null === (u2 = g2.y[0]) || void 0 === u2 ? void 0 : u2.y1 }), void 0 !== (null === (f2 = S2.globals.seriesRange) || void 0 === f2 || null === (p2 = f2[i2]) || void 0 === p2 || null === (x2 = p2[a2]) || void 0 === x2 || null === (b2 = x2.y[0]) || void 0 === b2 ? void 0 : b2.y2) && { y2: null === (v2 = S2.globals.seriesRange) || void 0 === v2 || null === (m2 = v2[i2]) || void 0 === m2 || null === (y2 = m2[a2]) || void 0 === y2 || null === (k2 = y2.y[0]) || void 0 === k2 ? void 0 : k2.y2 });
      if (A2) {
    ...
    return s(t2, [{ key: "handleBarDataLabels", value: function(t3) {
      var e2, i2, a2 = t3.x, s2 = t3.y, r2 = t3.y1, o2 = t3.y2, n2 = t3.i, l2 = t3.j, h2 = t3.realIndex, c2 = t3.columnGroupIndex, g2 = t3.series, u2 = t3.barHeight, f2 = t3.barWidth, p2 = t3.barXPosition, x2 = t3.barYPosition, b2 = t3.visibleSeries, v2 = t3.renderedPath, m2 = this.w, y2 = new w(this.barCtx.ctx), k2 = Array.isArray(this.barCtx.strokeWidth) ? this.barCtx.strokeWidth[h2] : this.barCtx.strokeWidth;
      m2.globals.isXNumeric && !m2.globals.isBarHorizontal ? (e2 = a2 + parseFloat(f2 * (b2 + 1)), i2 = s2 + parseFloat(u2 * (b2 + 1)) - k2) : (e2 = a2 + parseFloat(f2 * b2), i2 = s2 + parseFloat(u2 * b2));
      ...
      if (this.barCtx.lastActiveBarSerieIndex === s2 && x2.enabled) {
        var P2 = new w(this.barCtx.ctx).getTextRects(this.getStackedTotalDataLabel({ realIndex: s2, j: a2 }), f2.fontSize);
      ...
      if (this.barCtx.lastActiveBarSerieIndex === r2 && f2.enabled) {
        ...
        A2 ? (v2 = S2 - d2 - p2 - f2.offsetX, k2 = "end") : v2 = S2 + p2 + f2.offsetX + (this.barCtx.isReversed ? -(l2 + d2) : d2), m2 = y2 - h2.height / 2 + C2.height / 2 + f2.offsetY + d2;
      }
      ...
      var u2 = new B(this.barCtx.ctx), f2 = new w(this.barCtx.ctx), p2 = h2.formatter, x2 = null, b2 = c2.globals.collapsedSeriesIndices.indexOf(s2) > -1;
      if (h2.enabled && !b2) {
        x2 = f2.group({ class: "apexcharts-data-labels", transform: g2 });
        var v2 = "";
        void 0 !== a2 && (v2 = p2(a2, d(d({}, c2), {}, { seriesIndex: s2, dataPointIndex: r2, w: c2 }))), !a2 && c2.config.plotOptions.bar.hideZeroBarsWhenGrouped && (v2 = "");
    ...
    return s(t2, [{ key: "initVariables", value: function(t3) {
      ...
      var u2 = i2, f2 = a2;
      null !== (e2 = d2.config.series[l2].data[c2]) && void 0 !== e2 && e2.columnWidthOffset && (f2 = a2 - d2.config.series[l2].data[c2].columnWidthOffset / 2, u2 = i2 + d2.config.series[l2].data[c2].columnWidthOffset);
      var p2 = o2 / 2, x2 = f2 + p2, b2 = f2 + u2 - p2;
      s2 += 1e-3 - p2, r2 += 1e-3 + p2;
      ...
      if (d2.globals.previousPaths.length > 0 && (m2 = this.barCtx.getPreviousPath(l2, c2, false)), v2 = v2 + g2.line(x2, r2) + g2.line(b2, r2) + g2.line(b2, s2) + ("around" === d2.config.plotOptions.bar.borderRadiusApplication ? " Z" : " z"), m2 = m2 + g2.line(x2, s2) + y2 + y2 + y2 + y2 + y2 + g2.line(x2, s2) + ("around" === d2.config.plotOptions.bar.borderRadiusApplication ? " Z" : " z"), this.shouldApplyRadius(l2) && (v2 = g2.roundPathCorners(v2, d2.config.plotOptions.bar.borderRadius)), d2.config.chart.stacked) {
        var k2 = this.barCtx;
        (k2 = this.barCtx[n2]).yArrj.push(r2 - p2), k2.yArrjF.push(Math.abs(s2 - r2 + o2)), k2.yArrjVal.push(this.barCtx.series[h2][c2]);
      }
      ...
      (o2 = Array.isArray(o2) ? o2[l2] : o2) || (o2 = 0);
      var u2 = i2, f2 = a2;
      null !== (e2 = d2.config.series[l2].data[c2]) && void 0 !== e2 && e2.barHeightOffset && (u2 = i2 - d2.config.series[l2].data[c2].barHeightOffset / 2, f2 = a2 + d2.config.series[l2].data[c2].barHeightOffset);
      var p2 = o2 / 2, x2 = u2 + p2, b2 = u2 + f2 - p2;
      s2 += 1e-3 - p2, r2 += 1e-3 + p2;
      ...
      if (v2 = v2 + g2.line(r2, x2) + g2.line(r2, b2) + y2 + ("around" === d2.config.plotOptions.bar.borderRadiusApplication ? " Z" : " z"), m2 = m2 + g2.line(s2, x2) + y2 + y2 + y2 + y2 + y2 + g2.line(s2, x2) + ("around" === d2.config.plotOptions.bar.borderRadiusApplication ? " Z" : " z"), this.shouldApplyRadius(l2) && (v2 = g2.roundPathCorners(v2, d2.config.plotOptions.bar.borderRadius)), d2.config.chart.stacked) {
        var k2 = this.barCtx;
        (k2 = this.barCtx[n2]).xArrj.push(r2 + p2), k2.xArrjF.push(Math.abs(s2 - r2)), k2.xArrjVal.push(this.barCtx.series[h2][c2]);
      }
      return { pathTo: v2, pathFrom: m2 };
      ...
      var e2 = t3.prevPaths, i2 = t3.currPaths, a2 = t3.color, s2 = this.w, r2 = e2.x, o2 = e2.x1, n2 = e2.barYPosition, l2 = i2.x, h2 = i2.x1, c2 = i2.barYPosition, d2 = n2 + i2.barHeight, g2 = new w(this.barCtx.ctx), u2 = new v(), f2 = g2.move(o2, d2) + g2.line(r2, d2) + g2.line(l2, c2) + g2.line(h2, c2) + g2.line(o2, d2) + ("around" === s2.config.plotOptions.bar.borderRadiusApplication ? " Z" : " z");
      return g2.drawPath({ d: f2, fill: u2.shadeColor(0.5, v.rgb2hex(a2)), stroke: "none", strokeWidth: 0, fillOpacity: 1, classes: "apexcharts-bar-shadows" });
    ...
    return s(t2, [{ key: "draw", value: function(t3, e2) {
      ...
      for (var o2 = 0, n2 = 0; o2 < t3.length; o2++, n2++) {
        var l2, h2, c2, g2, u2 = void 0, f2 = void 0, p2 = [], x2 = [], b2 = i2.globals.comboCharts ? e2[o2] : o2, m2 = this.barHelpers.getGroupIndex(b2).columnGroupIndex, y2 = a2.group({ class: "apexcharts-series", rel: o2 + 1, seriesName: v.escapeString(i2.globals.seriesNames[b2]), "data:realIndex": b2 });
        ...
        f2 = L2.y, A2 = L2.barHeight, h2 = L2.yDivision, g2 = L2.zeroW, u2 = L2.x, S2 = L2.barWidth, l2 = L2.xDivision, c2 = L2.zeroH, this.horizontal || x2.push(u2 + S2 / 2);
        ...
        for (var T2 = 0; T2 < t3[o2].length; T2++) {
          ...
          R2 && M2.add(R2), f2 = X2.y, u2 = X2.x, T2 > 0 && x2.push(u2 + S2 / 2), p2.push(f2), this.renderSeries({ realIndex: b2, pathFill: Y2, j: T2, i: o2, columnGroupIndex: m2, pathFrom: X2.pathFrom, pathTo: X2.pathTo, strokeWidth: z2, elSeries: y2, x: u2, y: f2, series: t3, barHeight: Math.abs(X2.barHeight ? X2.barHeight : A2), barWidth: Math.abs(X2.barWidth ? X2.barWidth : S2), elDataLabelsWrap: P2, elGoalsMarkers: M2, elBarShadows: I2, visibleSeries: this.visibleI, type: "bar" });
        }
        i2.globals.seriesXvalues[b2] = x2, i2.globals.seriesYvalues[b2] = p2, r2.add(y2);
      }
      return r2;
    } }, { key: "renderSeries", value: function(t3) {
      var e2 = t3.realIndex, i2 = t3.pathFill, a2 = t3.lineFill, s2 = t3.j, r2 = t3.i, o2 = t3.columnGroupIndex, n2 = t3.pathFrom, l2 = t3.pathTo, h2 = t3.strokeWidth, c2 = t3.elSeries, d2 = t3.x, g2 = t3.y, u2 = t3.y1, f2 = t3.y2, p2 = t3.series, x2 = t3.barHeight, b2 = t3.barWidth, v2 = t3.barXPosition, m2 = t3.barYPosition, k2 = t3.elDataLabelsWrap, A2 = t3.elGoalsMarkers, S2 = t3.elBarShadows, C2 = t3.visibleSeries, L2 = t3.type, P2 = this.w, M2 = new w(this.ctx);
      if (!a2) {
      ...
      X2.count > 0 && s2 >= P2.globals.dataPoints - X2.count && (z2.node.setAttribute("stroke-dasharray", X2.dashArray), z2.node.setAttribute("stroke-width", X2.strokeWidth), z2.node.setAttribute("fill-opacity", X2.fillOpacity)), void 0 !== u2 && void 0 !== f2 && (z2.attr("data-range-y1", u2), z2.attr("data-range-y2", f2)), new y(this.ctx).setSelectionFilter(z2, e2, s2), c2.add(z2);
      var E2 = new yt(this).handleBarDataLabels({ x: d2, y: g2, y1: u2, y2: f2, i: r2, j: s2, series: p2, realIndex: e2, columnGroupIndex: o2, barHeight: x2, barWidth: b2, barXPosition: v2, barYPosition: m2, renderedPath: z2, visibleSeries: C2 });
      ...
      var y2 = this.barHelpers.getColumnPaths({ barXPosition: e2, barWidth: o2, y1: n2, y2: s2, strokeWidth: l2, series: this.series, realIndex: d2, i: u2, j: f2, w: c2 });
    ...
    return s(a2, [{ key: "draw", value: function(t3, e3) {
      ...
      for (var r2 = this.graphics.group({ class: "apexcharts-bar-series apexcharts-plot-series" }), o2 = 0, n2 = 0, l2 = function(s3, l3) {
        var h3 = void 0, c3 = void 0, g2 = void 0, u2 = void 0, f2 = a3.globals.comboCharts ? e3[s3] : s3, p2 = i2.barHelpers.getGroupIndex(f2), x2 = p2.groupIndex, b2 = p2.columnGroupIndex;
        ...
        var k2 = i2.graphics.group({ class: "apexcharts-series", seriesName: v.escapeString(a3.globals.seriesNames[f2]), rel: s3 + 1, "data:realIndex": f2 });
        i2.ctx.series.addCollapsedClassToSeries(k2, f2);
        var A2 = i2.graphics.group({ class: "apexcharts-datalabels", "data:realIndex": f2 }), S2 = i2.graphics.group({ class: "apexcharts-bar-goals-markers" }), C2 = 0, L2 = 0, P2 = i2.initialPositions(o2, n2, h3, c3, g2, u2, w2);
        ...
        for (var M2 = 0; M2 < a3.globals.dataPoints; M2++) {
          ...
          k2 = i2.renderSeries({ realIndex: f2, pathFill: E2, j: M2, i: s3, columnGroupIndex: b2, pathFrom: z2.pathFrom, pathTo: z2.pathTo, strokeWidth: I2, elSeries: k2, x: o2, y: n2, series: t3, barHeight: C2, barWidth: L2, elDataLabelsWrap: A2, elGoalsMarkers: S2, type: "bar", visibleSeries: b2 });
        }
        a3.globals.seriesXvalues[f2] = m2, a3.globals.seriesYvalues[f2] = y2, i2.groupCtx.prevY.push(i2.groupCtx.yArrj), i2.groupCtx.prevYF.push(i2.groupCtx.yArrjF), i2.groupCtx.prevYVal.push(i2.groupCtx.yArrjVal), i2.groupCtx.prevX.push(i2.groupCtx.xArrj), i2.groupCtx.prevXF.push(i2.groupCtx.xArrjF), i2.groupCtx.prevXVal.push(i2.groupCtx.xArrjVal), r2.add(k2);
      ...
      var k2 = this.barHelpers.getBarpaths({ barYPosition: u2, barHeight: a3, x1: e3, x2: o2, strokeWidth: s2, series: this.series, realIndex: i2.realIndex, seriesGroup: h2, i: f2, j: p2, w: g2 });
      ...
      var z2 = this.barHelpers.getColumnPaths({ barXPosition: v2, barWidth: r2, y1: b2, y2: a3, yRatio: this.yRatio[p2], strokeWidth: this.strokeWidth, series: this.series, seriesGroup: l2, realIndex: e3.realIndex, i: d2, j: g2, w: c2 });
    ...
    return s(a2, [{ key: "draw", value: function(t3, e3, i2) {
      ...
      for (var h2 = r2.group({ class: "apexcharts-".concat(o2, "-series apexcharts-plot-series") }), c2 = function(e4) {
        ...
        var o3, l3, c3, g3, u2 = void 0, f2 = void 0, p2 = [], x2 = [], b2 = s2.globals.comboCharts ? i2[e4] : e4, m2 = a3.barHelpers.getGroupIndex(b2).columnGroupIndex, y2 = r2.group({ class: "apexcharts-series", seriesName: v.escapeString(s2.globals.seriesNames[b2]), rel: e4 + 1, "data:realIndex": b2 });
        ...
        f2 = S2.y, w2 = S2.barHeight, l3 = S2.yDivision, g3 = S2.zeroW, u2 = S2.x, k2 = S2.barWidth, o3 = S2.xDivision, c3 = S2.zeroH, x2.push(u2 + k2 / 2);
        for (var C2 = r2.group({ class: "apexcharts-datalabels", "data:realIndex": b2 }), L2 = function(i3) {
          var r3 = a3.barHelpers.getStrokeWidth(e4, i3, b2), h3 = null, v2 = { indexes: { i: e4, j: i3, realIndex: b2, translationsIndex: A2 }, x: u2, y: f2, strokeWidth: r3, elSeries: y2 };
          h3 = a3.isHorizontal ? a3.drawHorizontalBoxPaths(d(d({}, v2), {}, { yDivision: l3, barHeight: w2, zeroW: g3 })) : a3.drawVerticalBoxPaths(d(d({}, v2), {}, { xDivision: o3, barWidth: k2, zeroH: c3 })), f2 = h3.y, u2 = h3.x, i3 > 0 && x2.push(u2 + k2 / 2), p2.push(f2), h3.pathTo.forEach(function(o4, l4) {
            ...
            a3.renderSeries({ realIndex: b2, pathFill: d2, lineFill: c4, j: i3, i: e4, pathFrom: h3.pathFrom, pathTo: o4, strokeWidth: r3, elSeries: y2, x: u2, y: f2, series: t3, columnGroupIndex: m2, barHeight: w2, barWidth: k2, elDataLabelsWrap: C2, visibleSeries: a3.visibleI, type: s2.config.chart.type });
          });
      ...
      t3.y;
      var a3 = t3.xDivision, s2 = t3.barWidth, r2 = t3.zeroH, o2 = t3.strokeWidth, n2 = this.w, l2 = new w(this.ctx), h2 = e3.i, c2 = e3.j, d2 = true, g2 = n2.config.plotOptions.candlestick.colors.upward, u2 = n2.config.plotOptions.candlestick.colors.downward, f2 = "";
      ...
      void 0 === this.series[h2][c2] || null === this.series[h2][c2] ? (y2 = r2, k2 = r2) : (y2 = r2 - y2 / p2, k2 = r2 - k2 / p2, v2 = r2 - b2.h / p2, m2 = r2 - b2.l / p2, A2 = r2 - b2.m / p2);
      var C2 = l2.move(S2, r2), L2 = l2.move(S2 + s2 / 2, y2);
      return n2.globals.previousPaths.length > 0 && (L2 = this.getPreviousPath(x2, c2, true)), C2 = this.isBoxPlot ? [l2.move(S2, y2) + l2.line(S2 + s2 / 2, y2) + l2.line(S2 + s2 / 2, v2) + l2.line(S2 + s2 / 4, v2) + l2.line(S2 + s2 - s2 / 4, v2) + l2.line(S2 + s2 / 2, v2) + l2.line(S2 + s2 / 2, y2) + l2.line(S2 + s2, y2) + l2.line(S2 + s2, A2) + l2.line(S2, A2) + l2.line(S2, y2 + o2 / 2), l2.move(S2, A2) + l2.line(S2 + s2, A2) + l2.line(S2 + s2, k2) + l2.line(S2 + s2 / 2, k2) + l2.line(S2 + s2 / 2, m2) + l2.line(S2 + s2 - s2 / 4, m2) + l2.line(S2 + s2 / 4, m2) + l2.line(S2 + s2 / 2, m2) + l2.line(S2 + s2 / 2, k2) + l2.line(S2, k2) + l2.line(S2, A2) + "z"] : [l2.move(S2, k2) + l2.line(S2 + s2 / 2, k2) + l2.line(S2 + s2 / 2, v2) + l2.line(S2 + s2 / 2, k2) + l2.line(S2 + s2, k2) + l2.line(S2 + s2, y2) + l2.line(S2 + s2 / 2, y2) + l2.line(S2 + s2 / 2, m2) + l2.line(S2 + s2 / 2, y2) + l2.line(S2, y2) + l2.line(S2, k2 - o2 / 2)], L2 += l2.move(S2, y2), n2.globals.isXNumeric || (i2 += a3), { pathTo: C2, pathFrom: L2, x: i2, y: k2, barXPosition: S2, color: this.isBoxPlot ? f2 : d2 ? [g2] : [u2] };
    ...
    return s(t2, [{ key: "checkColorRange", value: function() {
      ...
      var n2 = a2.globals.colors[o2], l2 = null, h2 = Math.min.apply(Math, f(a2.globals.series[e2])), c2 = Math.max.apply(Math, f(a2.globals.series[e2]));
    ...
    return s(t2, [{ key: "draw", value: function(t3) {
      ...
      for (var h2 = n2 ? 0 : l2.length - 1; n2 ? h2 < l2.length : h2 >= 0; n2 ? h2++ : h2--) {
        ...
        for (var g2 = 0, u2 = e2.config.plotOptions.heatmap.shadeIntensity, f2 = 0; f2 < l2[h2].length; f2++) {
          ...
          if ("image" === e2.config.fill.type) x2 = new O(this.ctx).fillPath({ seriesNumber: h2, dataPointIndex: f2, opacity: e2.globals.hasNegs ? b2.percent < 0 ? 1 - (1 + b2.percent / 100) : u2 + b2.percent / 100 : b2.percent / 100, patternID: v.randomId(), width: e2.config.fill.image.width ? e2.config.fill.image.width : s2, height: e2.config.fill.image.height ? e2.config.fill.image.height : r2 });
    ...
    return s(t2, [{ key: "draw", value: function(t3) {
      ...
      if (i2.globals.dataChanged) {
        ...
        for (var f2 = 0; f2 < i2.globals.previousPaths.length; f2++) d2 = this.fullAngle * v.negToZero(i2.globals.previousPaths[f2]) / g2, this.prevSectorAngleArr.push(d2);
      }
      ...
      var c2 = Math.PI * (h2 - 90) / 180, d2 = i2.centerX + r2 * Math.cos(l2), g2 = i2.centerY + r2 * Math.sin(l2), u2 = i2.centerX + r2 * Math.cos(c2), f2 = i2.centerY + r2 * Math.sin(c2), p2 = v.polarToCartesian(i2.centerX, i2.centerY, i2.donutSize, h2), x2 = v.polarToCartesian(i2.centerX, i2.centerY, i2.donutSize, n2), b2 = s2 > 180 ? 1 : 0, m2 = ["M", d2, g2, "A", r2, r2, 0, b2, 1, u2, f2];
      return e2 = "donut" === i2.chartType ? [].concat(m2, ["L", p2.x, p2.y, "A", i2.donutSize, i2.donutSize, 0, b2, 0, x2.x, x2.y, "L", d2, g2, "z"]).join(" ") : "pie" === i2.chartType || "polarArea" === i2.chartType ? [].concat(m2, ["L", i2.centerX, i2.centerY, "L", d2, g2]).join(" ") : [].concat(m2).join(" "), o2.roundPathCorners(e2, 2 * this.strokeWidth);
      ...
      if (r2 ? (o2 = e2.total.color, c2 = e2.total.fontSize, d2 = e2.total.fontFamily, g2 = e2.total.fontWeight, p2 = e2.total.label, f2 = e2.total.formatter(a2)) : 1 === a2.globals.series.length && (f2 = u2(a2.globals.series[0], a2), p2 = a2.globals.seriesNames[0]), p2 && (p2 = e2.name.formatter(p2, e2.total.show, a2)), e2.name.show) {
    ...
    return s(t2, [{ key: "draw", value: function(t3) {
      ...
      var o2 = i2.globals.gridWidth / 2, n2 = i2.globals.gridHeight / 2, l2 = o2 + i2.config.plotOptions.radar.offsetX, h2 = n2 + i2.config.plotOptions.radar.offsetY, c2 = this.graphics.group({ class: "apexcharts-radar-series apexcharts-plot-series", transform: "translate(".concat(l2 || 0, ", ").concat(h2 || 0, ")") }), g2 = [], u2 = null, f2 = null;
      if (this.yaxisLabels = this.graphics.group({ class: "apexcharts-yaxis" }), t3.forEach(function(t4, o3) {
        ...
        for (var x2 = 0; x2 < h3.linePathsTo.length; x2++) {
          var b2 = e2.graphics.renderPaths(d(d({}, c3), {}, { pathFrom: null === p3 ? h3.linePathsFrom[x2] : p3, pathTo: h3.linePathsTo[x2], strokeWidth: Array.isArray(e2.strokeWidth) ? e2.strokeWidth[o3] : e2.strokeWidth, fill: "none", drawShadow: false }));
          l3.add(b2);
          var m2 = a2.fillPath({ seriesNumber: o3 }), w2 = e2.graphics.renderPaths(d(d({}, c3), {}, { pathFrom: null === p3 ? h3.areaPathsFrom[x2] : p3, pathTo: h3.areaPathsTo[x2], strokeWidth: 0, fill: m2, drawShadow: false }));
        ...
        t4.forEach(function(t5, a3) {
          ...
          if (c4.enabled) {
            ...
            r2.plotDataLabelsText({ x: g2[a3].x, y: g2[a3].y, text: p4, textAnchor: "middle", i: o3, j: o3, parent: f2, offsetCorrection: false, dataLabelsConfig: d({}, c4) });
          }
          l3.add(f2);
        }), s2.push(l3);
    ...
    return s(a2, [{ key: "draw", value: function(t3, e3) {
      ...
      for (var s2 = a3.group({ class: "apexcharts-rangebar-series apexcharts-plot-series" }), r2 = 0; r2 < t3.length; r2++) {
        var o2, n2, l2, h2, c2 = void 0, g2 = void 0, u2 = i2.globals.comboCharts ? e3[r2] : r2, f2 = this.barHelpers.getGroupIndex(u2).columnGroupIndex, p2 = a3.group({ class: "apexcharts-series", seriesName: v.escapeString(i2.globals.seriesNames[u2]), rel: r2 + 1, "data:realIndex": u2 });
        ...
        for (var k2 = a3.group({ class: "apexcharts-datalabels", "data:realIndex": u2 }), A2 = a3.group({ class: "apexcharts-rangebar-goals-markers" }), S2 = 0; S2 < i2.globals.dataPoints; S2++) {
          var C2 = this.barHelpers.getStrokeWidth(r2, S2, u2), L2 = this.seriesRangeStart[r2][S2], P2 = this.seriesRangeEnd[r2][S2], M2 = null, I2 = null, T2 = null, z2 = { x: c2, y: g2, strokeWidth: C2, elSeries: p2 }, X2 = this.seriesLen;
          ...
          this.renderSeries({ realIndex: u2, pathFill: H2, lineFill: O2, j: S2, i: r2, x: c2, y: g2, y1: L2, y2: P2, pathFrom: M2.pathFrom, pathTo: M2.pathTo, strokeWidth: C2, elSeries: p2, series: t3, barHeight: x2, barWidth: b2, barXPosition: I2, barYPosition: T2, columnGroupIndex: f2, elDataLabelsWrap: k2, elGoalsMarkers: A2, visibleSeries: this.visibleI, type: "rangebar" });
        }
        s2.add(p2);
      }
      return s2;
  ...
  var Dt = function() {
    ...
    return s(t2, [{ key: "draw", value: function(t3, e2, i2, a2) {
      ...
      for (var c2 = [], g2 = 0; g2 < t3.length; g2++) {
        ...
        var u2 = r2.globals.comboCharts ? i2[g2] : g2, f2 = this.yRatio.length > 1 ? u2 : 0;
        ...
        C2 = this.lineHelpers.determineFirstPrevY({ i: g2, realIndex: u2, series: t3, prevY: C2, lineYPosition: 0, translationsIndex: f2 }).prevY, "monotoneCubic" === r2.config.stroke.curve && null === t3[g2][0] ? p2.push(null) : p2.push(C2), m2 = C2;
        "rangeArea" === n2 && (A2 = L2 = this.lineHelpers.determineFirstPrevY({ i: g2, realIndex: u2, series: a2, prevY: L2, lineYPosition: 0, translationsIndex: f2 }).prevY, x2.push(null !== p2[0] ? L2 : null));
        var P2 = this._calculatePathsFrom({ type: n2, series: t3, i: g2, realIndex: u2, translationsIndex: f2, prevX: S2, prevY: C2, prevY2: L2 }), M2 = [p2[0]], I2 = [x2[0]], T2 = { type: n2, series: t3, realIndex: u2, translationsIndex: f2, i: g2, x: v2, y: 1, pX: y2, pY: m2, pathsFrom: P2, linePaths: [], areaPaths: [], seriesIndex: i2, lineYPosition: 0, xArrj: b2, yArrj: p2, y2Arrj: x2, seriesRangeEnd: a2 }, z2 = this._iterateOverDataPoints(d(d({}, T2), {}, { iterations: "rangeArea" === n2 ? t3[g2].length - 1 : void 0, isRangeStart: true }));
        if ("rangeArea" === n2) {
      ...
      var e2, i2, a2, s2, r2 = t3.type, o2 = t3.series, n2 = t3.i, l2 = t3.realIndex, h2 = t3.translationsIndex, c2 = t3.prevX, d2 = t3.prevY, g2 = t3.prevY2, u2 = this.w, f2 = new w(this.ctx);
      if (null === o2[n2][0]) {
      ...
      if ("area" === e2) for (var f2 = n2.fillPath({ seriesNumber: i2 }), p2 = 0; p2 < s2.areaPaths.length; p2++) {
        var x2 = o2.renderPaths(d(d({}, u2), {}, { pathFrom: s2.pathFromArea, pathTo: s2.areaPaths[p2], stroke: "none", strokeWidth: 0, strokeLineCap: null, fill: f2 }));
      ...
      var e2, i2, a2 = this, s2 = t3.type, r2 = t3.series, o2 = t3.iterations, n2 = t3.realIndex, l2 = t3.translationsIndex, h2 = t3.i, c2 = t3.x, d2 = t3.y, g2 = t3.pX, u2 = t3.pY, f2 = t3.pathsFrom, p2 = t3.linePaths, x2 = t3.areaPaths, b2 = t3.seriesIndex, m2 = t3.lineYPosition, y2 = t3.xArrj, k2 = t3.yArrj, A2 = t3.y2Arrj, S2 = t3.isRangeStart, C2 = t3.seriesRangeEnd, L2 = this.w, P2 = new w(this.ctx), M2 = this.yRatio, I2 = f2.prevY, T2 = f2.linePath, z2 = f2.areaPath, X2 = f2.pathFromLine, E2 = f2.pathFromArea, Y2 = v.isNumber(L2.globals.minYArr[n2]) ? L2.globals.minYArr[n2] : L2.globals.minY;
      ...
      for (var O2, N2 = 0, W2 = 0; W2 < o2; W2++) {
        ...
        var V2 = this.lineHelpers.calculatePoints({ series: r2, x: c2, y: d2, realIndex: n2, i: h2, j: W2, prevY: I2 }), j2 = this._createPaths({ type: s2, series: r2, i: h2, realIndex: n2, j: W2, x: c2, y: d2, y2: R2, xArrj: y2, yArrj: k2, y2Arrj: A2, pX: g2, pY: u2, pathState: N2, segmentStartX: O2, linePath: T2, areaPath: z2, linePaths: p2, areaPaths: x2, curve: H2, isRangeStart: S2 });
      ...
      return { yArrj: k2, xArrj: y2, pathFromArea: E2, areaPaths: x2, pathFromLine: X2, linePaths: p2, linePath: T2, areaPath: z2 };
      ...
      t3.realIndex;
      var s2 = t3.j, r2 = t3.x, o2 = t3.y, n2 = t3.xArrj, l2 = t3.yArrj, h2 = t3.y2, c2 = t3.y2Arrj, d2 = t3.pX, g2 = t3.pY, u2 = t3.pathState, f2 = t3.segmentStartX, p2 = t3.linePath, x2 = t3.areaPath, b2 = t3.linePaths, v2 = t3.areaPaths, m2 = t3.curve, y2 = t3.isRangeStart;
      this.w;
      ...
      switch (m2) {
          ...
          switch (u2) {
            ...
            case 2:
              ...
              if (function(t4, e3) {
                ...
                L2 ? p2 = A2.move(T2[i3][0], T2[i3][1]) + e3 : C2 ? p2 = A2.move(X2[i3][0], X2[i3][1]) + A2.line(T2[i3][0], T2[i3][1]) + e3 + A2.line(X2[a3][0], X2[a3][1]) : (p2 = A2.move(T2[i3][0], T2[i3][1]) + e3, x2 = p2 + A2.line(T2[a3][0], S2) + A2.line(T2[i3][0], S2) + "z", v2.push(x2)), b2.push(p2);
              }), C2 && E2 > 1 && !L2) {
        ...
        case "smooth":
          ...
          if (null === i2[a2][s2]) u2 = 0;
            ...
            case 0:
              if (f2 = d2, p2 = L2 ? A2.move(d2, c2[s2]) + A2.line(d2, g2) : A2.move(d2, g2), x2 = A2.move(d2, g2), u2 = 1, s2 < i2[a2].length - 2) {
                var D2 = A2.curve(d2 + R2, g2, r2 - R2, o2, r2, o2);
                p2 += D2, x2 += D2;
                break;
              }
            case 1:
              if (null === i2[a2][s2 + 1]) p2 += L2 ? A2.line(d2, h2) : A2.move(d2, g2), x2 += A2.line(d2, S2) + A2.line(f2, S2) + "z", b2.push(p2), v2.push(x2), u2 = -1;
              else {
                var H2 = A2.curve(d2 + R2, g2, r2 - R2, o2, r2, o2);
                p2 += H2, x2 += H2, s2 >= i2[a2].length - 2 && (L2 && (p2 += A2.curve(r2, o2, r2, o2, r2, h2) + A2.move(r2, h2)), x2 += A2.curve(r2, o2, r2, o2, r2, S2) + A2.line(f2, S2) + "z", b2.push(p2), v2.push(x2), u2 = -1);
              }
          }
          d2 = r2, g2 = o2;
          break;
          ...
          if (null === i2[a2][s2]) u2 = 0;
            ...
            case 1:
              if (null === i2[a2][s2 + 1]) p2 += L2 ? A2.line(d2, h2) : A2.move(d2, g2), x2 += A2.line(d2, S2) + A2.line(f2, S2) + "z", b2.push(p2), v2.push(x2), u2 = -1;
                ...
                var W2 = O2(m2, r2, o2);
                p2 += W2, x2 += W2, s2 >= i2[a2].length - 2 && (L2 && (p2 += A2.line(r2, h2)), x2 += A2.line(r2, S2) + A2.line(f2, S2) + "z", b2.push(p2), v2.push(x2), u2 = -1);
              }
          }
          d2 = r2, g2 = o2;
      }
      return { linePaths: b2, areaPaths: v2, pX: d2, pY: g2, pathState: u2, segmentStartX: f2, linePath: p2, areaPath: x2 };
  ...
  var Ht, Ot, Nt = function() {
    ...
    return s(t2, [{ key: "calculateTimeScaleTicks", value: function(t3, e2) {
      ...
      var o2 = s2.getTimeUnitsfromTimestamp(t3, e2, this.utc), n2 = a2.globals.gridWidth / r2, l2 = n2 / 24, h2 = l2 / 60, c2 = h2 / 60, g2 = Math.floor(24 * r2), u2 = Math.floor(1440 * r2), f2 = Math.floor(r2 * Wt), p2 = Math.floor(r2), x2 = Math.floor(r2 / 30), b2 = Math.floor(r2 / 365), v2 = { minMillisecond: o2.minMillisecond, minSecond: o2.minSecond, minMinute: o2.minMinute, minHour: o2.minHour, minDate: o2.minDate, minMonth: o2.minMonth, minYear: o2.minYear }, m2 = { firstVal: v2, currentMillisecond: v2.minMillisecond, currentSecond: v2.minSecond, currentMinute: v2.minMinute, currentHour: v2.minHour, currentMonthDate: v2.minDate, currentDate: v2.minDate, currentMonth: v2.minMonth, currentYear: v2.minYear, daysWidthOnXAxis: n2, hoursWidthOnXAxis: l2, minutesWidthOnXAxis: h2, secondsWidthOnXAxis: c2, numberOfSeconds: f2, numberOfMinutes: u2, numberOfHours: g2, numberOfDays: p2, numberOfMonths: x2, numberOfYears: b2 };
      ...
      if (e2.minDate > 1) {
        ...
        var g2 = s2 + d2, u2 = v.monthMod(n2), f2 = n2;
      ...
      for (var p2 = n2 + 1, x2 = l2, b2 = 0, m2 = 1; b2 < o2; b2++, m2++) {
        0 === (p2 = v.monthMod(p2)) ? (c2 = "year", d2 += 1) : c2 = "month";
      ...
      for (var f2 = d2, p2 = 0; p2 < r2; p2++) {
        ...
        this.timeScaleArray.push({ position: f2, value: b2, unit: n2, year: x2, month: v.monthMod(u2), day: b2 });
      }
    ...
    return s(t2, [{ key: "setupElements", value: function() {
      ...
      var i2 = this.w, a2 = i2.config, s2 = i2.globals, r2 = { series: [], i: [] }, o2 = { series: [], i: [] }, n2 = { series: [], i: [] }, l2 = { series: [], i: [] }, h2 = { series: [], i: [] }, c2 = { series: [], i: [] }, d2 = { series: [], i: [] }, g2 = { series: [], i: [] }, u2 = { series: [], seriesRangeEnd: [], i: [] }, p2 = void 0 !== a2.chart.type ? a2.chart.type : "line", x2 = null, b2 = 0;
      s2.series.forEach(function(e3, a3) {
        var f2 = t3[a3].type || p2;
        switch (f2) {
          case "column":
          case "bar":
          ...
          case "radar":
            ...
            break;
          default:
            console.warn("You have specified an unrecognized series type (", f2, ").");
        }
        p2 !== f2 && "scatter" !== f2 && b2++;
      ...
      if (s2.comboCharts) {
        ...
        if (o2.series.length > 0) (S2 = A2).push.apply(S2, f(L2.drawSeriesByGroup(o2, s2.areaGroups, "area", v2)));
        ...
        if (u2.series.length > 0 && A2.push(v2.draw(u2.series, "rangeArea", u2.i, u2.seriesRangeEnd)), r2.series.length > 0) (C2 = A2).push.apply(C2, f(L2.drawSeriesByGroup(r2, s2.lineGroups, "line", v2)));
  ...
  Ht = "undefined" != typeof window ? window : void 0, Ot = function(t2, e2) {
    ...
    i2.PathArray = function(t3, e3) {
      ...
      t3 = null === t3 ? e3 : t3 instanceof i2.Element ? t3.matrixify() : "string" == typeof t3 ? f2(t3.split(i2.regex.delimiter).map(parseFloat)) : 6 == arguments.length ? f2([].slice.call(arguments)) : Array.isArray(t3) ? f2(t3) : t3 && "object" === x(t3) ? t3 : e3;
  ...
  function() {
    ...
    function a2(t3) {
      ...
      switch (t3[0]) {
        ...
        case "A":
          e3 = function(t4, e4) {
            var i3, a3, s3, r2, o2, n2, l2, h2, c2, d2, g2, u2, f2, p2, x2, b2, v2, m2, y2, w2, k2, A2, S2, C2, L2, P2, M2 = Math.abs(e4[1]), I2 = Math.abs(e4[2]), T2 = e4[3] % 360, z2 = e4[4], X2 = e4[5], E2 = e4[6], Y2 = e4[7], F2 = new SVG.Point(t4), R2 = new SVG.Point(E2, Y2), D2 = [];
